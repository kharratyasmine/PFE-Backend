...
import com.workpilot.service.GestionRessources.allocation.TeamMemberAllocationService;
...
public class TeamMemberAllocationController {
    ...
    public ResponseEntity<TeamMemberAllocationDTO> getAllocation(
        ...
        List<TeamMemberAllocation> allocations = allocationRepository.findAllByTeamMemberIdAndProjectIdAndTeamId(memberId, projectId , teamId);
    ...
    public ResponseEntity<TeamMemberAllocationDTO> getAllocationByMemberAndProject(@PathVariable Long memberId,
        ...
        TeamMemberAllocationDTO dto = teamMemberAllocationService.getAllocationByMemberAndProjectAndTeam(memberId, projectId, teamId);
        return ResponseEntity.ok(dto);
    }
