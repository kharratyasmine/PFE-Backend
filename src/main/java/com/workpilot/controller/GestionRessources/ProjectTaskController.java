...
public class ProjectTaskController {
    ...
    @PatchMapping("/tasks/{taskId}/assignment/{assignmentId}/workedMD")
    public ResponseEntity<Void> updateWorkedMD(
            @PathVariable Long taskId,
            @PathVariable Long assignmentId,
            @RequestBody Map<String, Double> body) {
        double workedMD = body.get("workedMD");
        taskService.updateWorkedMD(taskId, assignmentId, workedMD);
